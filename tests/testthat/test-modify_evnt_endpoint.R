test_that("evnt endpoint correctly generates the url", {
  ...
  expect_equal(modify_evnt_endpoint(baseurl = baseurl, program_id = "Ymn7RO0lkf7"),
               "https://clone.psi-mis.org/api/evnt?paging=true&totalPages=true&program=Ymn7RO0lkf7&pageSize=50")
  expect_equal(modify_evnt_endpoint(baseurl = baseurl, program_id = "Ymn7RO0lkf7", paging = F),
               "https://clone.psi-mis.org/api/evnt?paging=false&program=Ymn7RO0lkf7")
  expect_equal(modify_evnt_endpoint(baseurl = baseurl, program_id = "Ymn7RO0lkf7", startDate = "2018-01-01"),
               paste0(baseurl,"api/evnt?paging=true&totalPages=true&program=Ymn7RO0lkf7&pageSize=50&startDate=2018-01-01"))
  expect_equal(modify_evnt_endpoint(baseurl = baseurl, program_id = "Ymn7RO0lkf7", endDate = "2018-01-01"),
               paste0(baseurl,"api/evnt?paging=true&totalPages=true&program=Ymn7RO0lkf7&pageSize=50&endDate=2018-01-01"))
  expect_equal(modify_evnt_endpoint(baseurl = baseurl, program_id = "Ymn7RO0lkf7", startDate = "2018-01-01", pageSize = 100),

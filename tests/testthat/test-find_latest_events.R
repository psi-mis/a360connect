...
test_that("Find latest events returns unique events", {
  d <- find_latest(testd)
...
test_that("Find latest by name identifies the latest unique events from a df of events with duplicated names", {
